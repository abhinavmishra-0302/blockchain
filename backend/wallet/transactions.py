...
from backend.config.config import MINING_REWARD, MINING_REWARD_INPUT
from backend.wallet.wallet import Wallet


class Transactions:
    """
    Document of an exchange in currency from a sender to one or
    more recipients.
    """
...
def main():
    ...
    transaction = Transactions(sender_wallet, 'recipient', 15)
